...
namespace game
{
    ...
    {
        void CharacterCollisionComponent::Create(engine::managers::EntityManager::Entity entity, const glm::dvec2& position, const glm::ivec2& size, bool isPlayerEntity)
        {
        ...
        std::vector<engine::common::Event*> CharacterCollisionComponent::Update(const std::vector<CollisionComponent*>& collisionComponents)
        {
        ...
        void CharacterCollisionComponent::Receive(engine::common::Event* message)
        {
