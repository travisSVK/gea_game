...
namespace engine
{
    ...
    {
        void CollisionComponent::Create(managers::EntityManager::Entity entity, const glm::dvec2& position, const glm::ivec2& size)
        {
            m_entity = entity;
            m_size = size;
            m_enabled = true;
        ...
        managers::EntityManager::Entity CollisionComponent::GetEntity()
        {
            return m_entity;
        }
